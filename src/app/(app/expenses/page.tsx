...
export default function ExpensesPage() {
  ...
  const [branch, setBranch] = useState(currentBranch); // Set initial branch from context
  ...
  // Keep form branch in sync with context
  useEffect(() => {
  ...
  const handleSaveExpense = async (e: React.FormEvent) => {
    ...
    if(result.success) {
      ...
      // Keep branch set to current branch
      setCategory('');
      setAmount('');
      setDescription('');
                    ...
                    <CardContent className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={branch} onValueChange={setBranch} disabled>
                                    <SelectTrigger>
